%% run anaerobic minimal analysis
%load models of aerobic organisms
Ecoli = readCbModel('iML1515.mat'); Scerevisiae = readCbModel('iMM904_Scerevisiae.mat');
Bsubtilis = readCbModel('iYO844_subtilis.mat'); Cdahlii = readCbModel('iHN637_dahlii.mat');
...
speciesList = {Ecoli, Scerevisiae,Cdahlii, Llactis ,Bsubtilis, Scystis, Paeruginosa, Soneidensis, Kpneumoniae};
biomassList = {'BIOMASS_Ec_iML1515_core_75p37M','BIOMASS_SC5_notrace','BIOMASS_Cl_DSM_WT_46p666M1','BIOMASS_LLA','BIOMASS_BS_10','BIOMASS_Ec_SynHetero','PA_Biomass6_DM','Biomass','Biomass'};
spNameList = {'Ecoli','Scerevisiae','Cdahlii','Llactis','Bsubtilis','Scystis','Paeruginosa','Soneidensis','Kpneumoniae'};
